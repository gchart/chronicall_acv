		...
		$.ajax(settings).done(function (response) {
            ...
            for (var agent = 0, num_agents = response.subReports.length; agent < num_agents; agent++) {
                ...
                tableData.push({
                    ...
                    "date": '1970-01-01',
                    "inbound_calls": response.subReports[agent].summaryItems[1].value,
                    "outbound_calls": response.subReports[agent].summaryItems[2].value,
                    "internal_calls": response.subReports[agent].summaryItems[3].value,
                    "inbound_duration": response.subReports[agent].summaryItems[5].value,
                    "outbound_duration": response.subReports[agent].summaryItems[6].value,
                    "internal_duration": response.subReports[agent].summaryItems[7].value
                });
                */
